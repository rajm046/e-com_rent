...
<body class="hold-transition skin-blue layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content-wrapper"
            style="background-image: url('images/profile3.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;opacity: 0.9;">
            <div class="container">
